...
- [x] **Asisten AI Percakapan Teks & Visual Cerdas (`AiAssistantDialog` & `AiAssistantService`)**: Fitur konsultasi cerdas berbasis teks dan kartu visual. Dilengkapi filter sapaan umum/chit-chat tanpa memicu kartu produk, deteksi pertanyaan opini murni tanpa kartu rekomendasi, serta pelacakan riwayat rekomendasi untuk saran alternatif ("cari yang lain") dan pertanyaan lanjutan ("kalau yang Excellent?"). Audio playback TTS ditiadakan untuk kenyamanan pengguna.

        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 4. Section Navbar (1, 2, 3 Sesuai Gambar 2)
              const Text(
                'Navbar',
                style: TextStyle(
                  fontSize: 14,
              ...
              Row(
                children: [1, 2, 3].map((styleIndex) {
                  final isSelected = _selectedNavbarStyle == styleIndex;
                  return Padding(
                    padding: const EdgeInsets.only(right: 12.0),
                    child: InkWell(
                      key: ValueKey('navbar_style_$styleIndex'),
                      onTap: () {
                        setState(() {
                          _selectedNavbarStyle = styleIndex;
                        });
                      },
                      ...
                      child: Container(
                        ...
                        height: 38,
                        decoration: BoxDecoration(
                          color: isSelected ? const Color(0xFF4A301E) : Colors.white,
                          borderRadius: BorderRadius.circular(6),
                          border: Border.all(
                            color: isSelected ? const Color(0xFF4A301E) : const Color(0xFF9E9E9E),
                            width: 1.2,
                          ),
                        ),
                        alignment: Alignment.center,
              ...
              // 5. Section Font (Dropdown / Selector Sesuai Gambar 2)
              const Text(
                'Font',
                style: TextStyle(
                  fontSize: 14,
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    key: const ValueKey('font_selector_dropdown'),
                    value: _selectedFont,
                    isExpanded: true,
                    icon: const Icon(Icons.arrow_drop_down, color: Color(0xFF555555)),
                    items: AppSettingsService.availableFonts.map((font) {
